...
import { getEmotionalPageApi, deleteEmotionalDiaryApi } from '@/apis/admin'
...
<template>
  <div>
    ...
    <el-pagination
      ...
      @change="handleChange"
    />
    <el-dialog v-model="dialogVisible" title="详情" width="800" :close-on-click-modal="false">
